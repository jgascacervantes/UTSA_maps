...
/**
 * Provides access to the location database.
 */
public class LocationsProvider extends ContentProvider {
    String TAG = "LocationsProvider";

    public static String AUTHORITY = "ts.mapapp.LocationsProvider";
    ...
    private DatabaseTable mLocations;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "locations", SEARCH_WORDS);
        matcher.addURI(AUTHORITY, "locations/#", GET_WORD);
        // to get suggestions...
    ...
    public boolean onCreate() {
        mLocations = new DatabaseTable(getContext());
        return true;
    }
    ...
    private Cursor search(String query) {
        ...
        return mLocations.getWordMatches(query, null);
    }
    ...
    private Cursor getWord(Uri uri) {
        ...
        return mLocations.getWord(rowId, columns);
    }
